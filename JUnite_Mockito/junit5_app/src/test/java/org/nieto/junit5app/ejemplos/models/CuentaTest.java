...
//        assertNotEquals(cuenta2, cuenta);
   ...
   // @Disabled
    ...
    class PruebasParametrizadasTest{
        ...
        void testDebitoCuentaValueSource(String dinero) {
            cuenta.debito(new BigDecimal(dinero));
            assertNotNull(cuenta.getSaldo());
            assertTrue(cuenta.getSaldo().compareTo(BigDecimal.ZERO) >= 0);
        }
        ...
        void testDebitoCuentaCsvSource(String index, String dinero) {
            System.out.println(index + " -> " + dinero);
            cuenta.debito(new BigDecimal(dinero));
            assertNotNull(cuenta.getSaldo());
            assertTrue(cuenta.getSaldo().compareTo(BigDecimal.ZERO) >= 0);
        }
        ...
        void testDebitoCuentaCsvSource2(String saldo, String dinero, String esperado, String actual) {
        ...
        void testDebitoCuentaCsvFileSource(String dinero) {
            cuenta.debito(new BigDecimal(dinero));
            assertNotNull(cuenta.getSaldo());
            assertTrue(cuenta.getSaldo().compareTo(BigDecimal.ZERO) >= 0);
        }
        ...
        void testDebitoCuentaCsvFileSource2(String saldo, String dinero, String esperado, String actual) {
            cuenta.setSaldo(new BigDecimal(saldo));
            cuenta.setPersona(esperado);
            cuenta.debito(new BigDecimal(dinero));
    ...
    @Tag("param")
    @ParameterizedTest(name = "numero {index} ejecutando con valor {0} - {argumentsWithNames}")
    @MethodSource("dineroList")
    void testDebitoCuentaMethodSource(String dinero) {
        cuenta.debito(new BigDecimal(dinero));
        assertNotNull(cuenta.getSaldo());
        assertTrue(cuenta.getSaldo().compareTo(BigDecimal.ZERO) >= 0);
    }

    static List<String> dineroList() {
